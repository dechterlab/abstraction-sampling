...
int32_t BucketElimination::Bucket::ComputeOutputFunctions(bool DoMomentMatching, signed char approx_bound)
{
...
::fflush(ARE::fpLOG) ; }*/
	...
	if (CreateTables) {
//INT64 t1 = ARE::GetTimeInMilliseconds() ;
		if (0 != ComputeOutputFunctions(doMomentMatching, Bound)) {
