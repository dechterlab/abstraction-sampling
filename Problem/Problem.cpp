...
int32_t ARE::ARP::LoadVariableOrderingFromBuffer(int32_t OrderType, int format, bool test, const char *SerializedVarListInElimOrder)
{
	if (_nVars <= 0) 
		return 0 ;
...
int32_t ARE::ARP::ComputeSingletonConsistency(int32_t & nNewSingletonDomainVariables, int32_t & nVarsWithReducedDomainSize)
{
	nNewSingletonDomainVariables = nVarsWithReducedDomainSize = 0 ;
